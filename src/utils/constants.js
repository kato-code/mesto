...
export const nameCardInput = document.querySelector("#place");
export const linkCardInput = document.querySelector("#link");
...
export const popupConfirm = document.querySelector(".popup_type_check");
export const titlePopupConfirm = document.querySelector(".popup__title_type_check");
export const submitPopupConfirmButton = document.querySelector("#save-check");

export const popupAvatar = document.querySelector(".popup_type_avatar");
export const openPopupAvatarButton = document.querySelector((".profile__avatar"));
